class TicketValidation:
    ...
    def __init__(self, ticket_id: int, validator_id: int, approved: bool):
        self.id = None
    ...
    @classmethod
    def add(cls, ticket_id: int, validator_id: int, approved: bool):
        obj = cls(ticket_id, validator_id, approved)
    ...
    def update(cls, obj_id: int, **kwargs):
        ...
        if not obj:
            raise ValueError("TicketValidation not found.")
