...
# This file is based on glpi_api.py from the python-glpi-api project:
# https://github.com/unistra/python-glpi-api
#
# The original file did not contain explicit author information.
#
...
# You should have received a copy of the GNU GPL version 3 along with this file.
