class ITILSolution:
    ...
    def __init__(self, ticket_id: int, solution_text: str):
        self.id = None
        self.ticket_id = ticket_id
        self.solution_text = solution_text

    @classmethod
    def add(cls, ticket_id: int, solution_text: str):
        obj = cls(ticket_id, solution_text)
    ...
    def update(cls, obj_id: int, **kwargs):
        ...
        if not obj:
            raise ValueError("ITILSolution not found.")
